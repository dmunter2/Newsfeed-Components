...
/*
 Step 1: Create a
 function that creates a component.You will want your component to look like the template below:
...
function createArticle(data) {
    ...
    childH2.classList.add('date');
    childH2.textContent = data.title;
    article.appendChild(childH2);


    let childp = document.createElement('p');
    childp.textContent = data.date;
